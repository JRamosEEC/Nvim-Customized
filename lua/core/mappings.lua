...
M.general = {
  ...
  n = {
    ...
    -- save
    --["<C-s>"] = { "<cmd> w <CR>", "Save file" }, --I save old fashioned way but leave <C-x> as alternative like <leader>x (saves and closes)
    ["<C-x>"] = { "<cmd> w <CR>", "Save file" },
...
M.nvimtree = {
  ...
  n = {
    -- toggle (Custom change - Original: "<cmd> NvimTreeToggle <CR>" - This enforces that dapui is closed before we toggle tree. Prevents changing window size.)
    --["<C-n>"] = { ":lua require('dapui').close()<CR> <BAR> <cmd> NvimTreeToggle <CR>", "Toggle nvimtree" },
    ["<C-n>"] = { "<cmd> NvimTreeToggle <CR>", "Toggle nvimtree" },

    -- focus (Custom change - Original: "<cmd> NvimTreeFocus <CR>" - This enforces that dapui is closed before we toggle tree. Prevents changing window size.)
    --["<leader>e"] = { ":lua require('dapui').close()<CR> <BAR> <cmd> NvimTreeFocus <CR>", "Focus nvimtree" },
...
M.telescope = {
  ...
  n = {
    ...
    --["<leader>fw"] = { "<cmd> Telescope live_grep <CR>", "Live grep" }, -- The original changed for override <leader>fw arguments that provide a faster search
